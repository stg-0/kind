...
NOTE: Para versiones de Kubernetes superiores a la 1.26, la instalación requiere una imagen personalizada con parámetros necesarios para Elasticsearch y el plugin de ECR para el _kubelet_.
